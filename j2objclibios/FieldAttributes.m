...
@implementation GSONFieldAttributes

- (instancetype)initWithJavaLangReflectField:(JavaLangReflectField *)f {
  GSONFieldAttributes_initWithJavaLangReflectField_(self, f);
  return self;
}
...
void GSONFieldAttributes_initWithJavaLangReflectField_(GSONFieldAttributes *self, JavaLangReflectField *f) {
  NSObject_init(self);
  (void) GSON_Gson_Preconditions_checkNotNullWithId_(f);
  self->field_ = f;
}

GSONFieldAttributes *new_GSONFieldAttributes_initWithJavaLangReflectField_(JavaLangReflectField *f) {
  J2OBJC_NEW_IMPL(GSONFieldAttributes, initWithJavaLangReflectField_, f)
}

GSONFieldAttributes *create_GSONFieldAttributes_initWithJavaLangReflectField_(JavaLangReflectField *f) {
  J2OBJC_CREATE_IMPL(GSONFieldAttributes, initWithJavaLangReflectField_, f)
}
