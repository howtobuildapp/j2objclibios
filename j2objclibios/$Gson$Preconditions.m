...
__attribute__((unused)) static GSON_Gson_Preconditions *new_GSON_Gson_Preconditions_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static GSON_Gson_Preconditions *create_GSON_Gson_Preconditions_init();
