...
/*!
 @brief Returns a new GsonBuilder containing all custom factories and configuration used by the current
  instance.
...
inline jboolean GSONGson_get_DEFAULT_JSON_NON_EXECUTABLE();
...
FOUNDATION_EXPORT GSONGson *new_GSONGson_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT GSONGson *create_GSONGson_init();
...
FOUNDATION_EXPORT GSONGson_FutureTypeAdapter *new_GSONGson_FutureTypeAdapter_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT GSONGson_FutureTypeAdapter *create_GSONGson_FutureTypeAdapter_init();
