...
/*!
 @brief By default, Gson is strict and only accepts JSON as specified by 
 <a href="http://www.ietf.org/rfc/rfc4627.txt">RFC 4627</a>.This option makes the parser
  liberal in what it accepts.
 @return a reference to this <code>GsonBuilder</code> object to fulfill the "Builder" pattern
 - seealso: JsonReader#setLenient(boolean)
 */
...
/*!
 @brief Constructs a GsonBuilder instance from a Gson instance.The newly constructed GsonBuilder
...
FOUNDATION_EXPORT GSONGsonBuilder *new_GSONGsonBuilder_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT GSONGsonBuilder *create_GSONGsonBuilder_init();
